...
{
    /// <summary>
    ///     Interaction logic for ComposantView.xaml
    /// </summary>
    ...
    public partial class ComposantView : MvxWpfView
    {
        ...
        {
            var set = this.CreateBindingSet<ComposantView, ComposantViewModel>();
        ...
        private void ListView_SizeChangedMatiere(object sender, SizeChangedEventArgs e)
        {
            var listView = sender as ListView;
            var gView = listView.View as GridView;
